<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li class="nav-item">
                <a href="<?= route('student/') ?>" class="nav-link text-white align-middle px-0">
            ...
            <li>
                ...
                <ul class="collapse nav flex-column ms-1" id="subject">
                    <li class="w-100">
                        <a href="<?= route('student/subject.php') ?>" class="ms-2 nav-link text-white px-0">Manage Subject</a>
                    </li>
                </ul>
                <ul class="collapse nav flex-column ms-1" id="subject">
                    <li class="w-100">
                        <a href="<?= route('student/subject-add.php') ?>" class="ms-2 nav-link text-white px-0">Add Subject</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="collapse nav flex-column ms-1" id="result">
                    <li class="w-100">
                        <a href="<?= route('student/result.php') ?>" class="ms-2 nav-link text-white px-0">View Result</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <div class="dropdown pb-4">
            ...
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                <li><a class="dropdown-item" href="<?= route('student/profile.php') ?>">Profile</a></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" href="<?= route('student/index.php?logout=1') ?>">Sign out</a></li>
            </ul>
        </div>
    </div>
</div>