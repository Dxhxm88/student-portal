...
$session = getSession($_GET['session_id']);

if (isset($_POST['submit'])) {
    updateSession($_POST, $_GET['session_id']);
}
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                <div class="container">
                    ...
                    <div class="mt-2">
                        <a href="<?= route('admin/session.php') ?>" class="btn btn-secondary">Back</a>
                    </div>
                    ...
                    <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-control" required>
                                ...
                                <option value="not active" <?= $session['status'] == 'not active' ? 'selected' : '' ?>>Not Active</option>
                            </select>
                        </div>
